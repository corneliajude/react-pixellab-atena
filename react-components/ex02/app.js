...
console.warn(`Folosind obiectul person si reduce, afiseaza in
consola un string care contine skill-urile de pe pozitiile pare
ale arrayului, separate prin virgula
`);
...
console.warn(`In mod similar, afiseaza
skill-urile care NU incep cu j.`);

const skillArray2 = person.skills.reduce((skillArray2, skill, index) => {
...
console.warn(`Folosind reduce afiseaza propozitia:
"Prietenii mei se numesc xxx yyy, xxx yyy, xxx yyy."
`);
// ---------> destructurare ptr friend {name} {surname}
...
// il au persoanele din arrayul friends, doar daca varsta este mai mare
// sau egala cu 30 de ani.`);

// const message2 = person.friends.reduce((message2, { age }, index, friends) => {
//   let total = 0;
//   while (index < friends.length) {
//     let totalAge = 0;
//     if (age >= 30) {
//       message2 = totalAge + age;
//     }
//     index = index + 1;
//   }
