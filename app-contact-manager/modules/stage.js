...
import { render as renderEditContact } from './editContacts.js';
...
stage.addEventListener('submit', (event) => {
  ...
  const form = target;
  // scoatem elementele de DOM din form editContacts.js
  ...
  clearMessages();
  addMessage(
    createMessage(`Contact ${contact.name} ${contact.surname} was updated.`),
  );
});
